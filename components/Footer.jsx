  ...
  return (
    <div className="md:block bg-gray-600 p-6 text-center text-white font-extralight">
      ...
      <ul className="flex justify-center items-center gap-6">
        <li>
          <a href="https://www.unifetv.com/" className="flex items-center gap-2 hover:scale-105 transition">
            <img src="https://www.unifetv.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Funife-gray.f49635ce.png&w=256&q=100" className="h-12" alt="Logo UnifeTv"/>
          </a>
        </li>
        <li>
          <a href="https://redaleluya.com.ar/" className="flex items-center gap-2 hover:scale-105 transition">
