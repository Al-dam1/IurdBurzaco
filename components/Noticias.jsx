    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 gap-5 justify-items-start ">
       ...
       <div className="p-4 text-left  ">
          ...
          <p className="text-sm text-gray-600">El sabado 24 de enero se tendra el evento Luau , en la catedral de mi familia en Lomas de Zamora a las 16hs, y BUrzaco estara presente y te invita a este super evento
          </p>
        </div>
