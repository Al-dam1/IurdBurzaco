  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center gap-5 flex-wrap ">
        ...
        <div className="p-4 text-center ">
          <img src="/img/boxeo.jpg" className="w-62 h-62 object-cover mx-auto rounded-lg"/>
          <h3 className="text-lg font-bold mt-2">xmakadlad </h3>
          <p className="text-sm text-gray-600">
            Es HOY! <br /> esta gran concentracion!
          </p>
        </div>
        <div className="p-4 text-center ">
          <img src="/img/boxeo2.jpg" className="w-62 h-62 object-cover mx-auto rounded-lg"/>
          <h3 className="text-lg font-bold mt-2">loremndlandak</h3>
          <p className="text-sm text-gray-600">
            Es HOY! <br /> esta gran concentracion!
          </p>
        </div>
